...
def _ytdl(bot, message, isZip=False, isLeech=False):
    ...
    if not is_url(link):
        ...
        help_msg += "\n<code>/command</code> link |newname pswd: xx(zip) opt: x:y|x1:y1"
        help_msg += "\n\n<b>Or reply to link:</b>"
        help_msg += "\n<code>/command</code> |newname pswd: xx(zip) opt: x:y|x1:y1"
     ...
     #   help_msg += "\n<code>/command</code> 10(number of links). Number should be always before |newname, pswd: and opt:"
