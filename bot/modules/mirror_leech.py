...
def _mirror_leech(bot, message, isZip=False, extract=False, isQbit=False, isLeech=False):
    ...
    if not is_url(link) and not is_magnet(link):
        help_msg = "<b>Send link along with command:</b>"
        if isQbit:
    #         help_msg += "\n<code>/command</code> {link} pswd: xx [zip/unzip]"
    #         help_msg += "\n\n<b>Or reply to link/file:</b>"
    #    #     help_msg += "\n<code>/command</code> pswd: xx [zip/unzip]"
    #    #     help_msg += "\n\n<b>Bittorrent selection:</b>"
    #         help_msg += "\n<code>/command</code> <b>s</b> {link} or reply to {file/link}"
    #         help_msg += "\n\n<b>Qbittorrent seed</b>:"
    #         help_msg += "\n<code>/command</code> <b>d</b> {link} replying to {file/link}.\n"
