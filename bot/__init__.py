...
try:
    ...
    START_BTN1_URL = 'https://t.me/t.me/octabots'
...
try:
    ...
    START_BTN2_NAME = 'Support'
    START_BTN2_URL = 'https://t.me/t.me/octabots'
try:
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/t.me/octabots'
except KeyError:
    AUTHOR_URL = 'https://t.me/t.me/octabots'
try:
...
try:
    ...
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by OctaBots ML Bot'
except KeyError:
    GD_INFO = 'Uploaded by OctaBots ML Bot'
try:
...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @octabots")
    CHANNEL_USERNAME = "octabots"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @octabots")
    FSUB_CHANNEL_ID = -10014282275949
try:
